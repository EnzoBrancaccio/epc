...
public class ValueToKeyFinderTest {
	...
	void testMinimalDifference() {
		ArrayList<HashMap<String, String>> listOfTestMaps = new ArrayList<HashMap<String, String>>();
		...
		ArrayList<HashMap<String, String>> listOfTestMaps234 = new ArrayList<HashMap<String, String>>();
